...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
  ...
  return (
    <section className="relative py-24 md:py-48 bg-charcoal overflow-hidden">
        ...
        >
          ...
          >
            <div className="space-y-2 md:space-y-1">
              <h2 className="text-cream font-display text-3xl md:text-[40px] leading-tight md:leading-[53px] tracking-tightest">
                {title}
              </h2>
            </div>

            <p className="text-cream/60 text-sm md:text-[15px] leading-6">
              {description}
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.div
              className="absolute w-[300px] h-[317px] md:w-[472px] md:h-[500px] bg-walnut/40 rounded-[32px] z-0"
              style={{
            ...
            {/* Main Mockup Card */}
            <motion.div
              className="relative w-full h-[405px] md:h-[637px] bg-cream/[0.04] rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border-0 z-10 overflow-hidden"
              initial={{ y: 0 }}
              whileInView={{ y: reverseLayout ? 20 : 30 }}
      ...
      <div
        ...
        style={{
          background: "radial-gradient(50% 50% at 50% 50%, rgba(246,241,234,0.24) 0%, rgba(246,241,234,0) 100%)",
        }}
      />
    </section>
  );
